...
const CHROMA_KEYS: readonly Rgb[] = [
  [0, 255, 0],
  [255, 0, 255],
  [0, 255, 255],
];
...
function keyedAndNeutralChannels(target: Rgb) {
...
function average(data: Buffer, index: number, channels: readonly number[]) {
  return (
