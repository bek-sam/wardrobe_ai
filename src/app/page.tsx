      ...
      <main>
        <section className="landing-hero">
          <div className="landing-hero__copy">
            ...
            <p>
              Wardrobe AI understands what you own, what your day requires, and how you like to
              dress.
            </p>
            ...
            <p className="landing-hero__trust">
              <LockKey size={15} weight="fill" /> Private images. Account-scoped data. You approve
              every change.
            </p>
          </div>
          <div
            className="landing-hero__visual"
            aria-label="Illustrative outfit recommendation preview"
          >
        ...
        <section className="landing-private">
          ...
          <div className="landing-private__copy">
            <p>
              Images remain private, files use short-lived access links, and your wardrobe is
