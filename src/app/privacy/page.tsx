import { ArrowLeft, Eye, LockKey, ShieldCheck, Trash } from "@phosphor-icons/react/ssr";
      ...
      <main className="legal-main">
        ...
        <div className="legal-principles">
          <article>
            ...
            <p>
              Wardrobe photos and generated images are intended to remain private and accessible
              only through short-lived links.
            </p>
          </article>
          <article>
            <Eye size={23} />
        ...
        <article className="legal-document">
          <section>
            ...
            <p>
              Account information, optional profile and size preferences, wardrobe metadata, images
              you choose to upload, saved outfits, plans, feedback, and wear history. Sensitive
