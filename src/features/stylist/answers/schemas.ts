...
import { AVAILABILITY_STATUSES } from "@/features/wardrobe/types";
import { OUTFIT_ITEM_ROLES } from "@/features/outfits/types";
// Deep import on purpose: the orchestrator barrel pulls in server-only
// modules, and this file is shared with the browser bundle.
import { INSIGHT_FOCUSES } from "@/lib/ai/agents/orchestrator/intent/types";
