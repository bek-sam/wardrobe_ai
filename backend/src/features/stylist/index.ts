 ...
 * usable while AI Orchestration is unavailable. The generation flags gate only the
...
export type StylistCapabilities = {
  ...
  /** Private AI orchestration service: outfit requests. */
  outfitGenerationAvailable: boolean;
  /** Private AI orchestration service: planning and packing. */
